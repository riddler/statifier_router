...
- `StatifierRouter.Config.new/1` takes `:bindings`, built through `StatifierRouter.Binding.new/1` with a duplicate binding id refused, and a required `:delivery` module that `route/3` hands each delivery to.
