defmodule StatifierRouter.Config do
  ...
  # by StatifierRouter.Delivery on each call. `:execution_id` (ADR-0002, the
  # Amendment of 2026-09-25) is checked the same way, against `execution_id/3`.
  defp hooks(opts, hooks) do
